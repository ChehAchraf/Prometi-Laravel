...
<head>
    ...
    <title>Erreur Serveur - Prometi</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full mx-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Erreur Serveur</h2>
            <p class="text-gray-600 mb-6">Une erreur inattendue s'est produite sur notre serveur.</p>

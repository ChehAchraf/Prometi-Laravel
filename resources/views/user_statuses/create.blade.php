...
@section('title', 'Create User Status')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Create New Status</h1>
        <p class="text-gray-600">Add a new user status option</p>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-1 flex items-center space-x-3">
                        ...
                        <input type="text" id="colorHex" value="{{ old('color', '#10B981') }}" 
                ...
                <div>
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input type="text" name="icon" id="icon" value="{{ old('icon', 'fas fa-check-circle') }}" 

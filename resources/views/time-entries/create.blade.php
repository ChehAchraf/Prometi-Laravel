...
<div class="container mx-auto px-4">
    ...
    <form action="{{ route('time-entries.store') }}" method="POST" class="bg-white shadow rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-1">
                ...
                <div class="mt-2">
                    <button type="button" id="load_users_btn" class="px-2 py-1 bg-gray-100 text-gray-700 rounded-md text-sm">
    ...
    <div class="mt-6 bg-white shadow rounded-lg p-6 border-l-4 border-yellow-500">
        ...
        <p class="text-sm text-gray-600 mb-4">Cette section est uniquement visible dans les environnements de développement.</p>
        ...
        <div class="mb-4">
            ...
            <ul class="list-disc list-inside text-sm">
                ...
                <li>URL de recherche: <a href="{{ route('users.search') }}?search=test" target="_blank" class="text-blue-600 hover:underline">{{ route('users.search') }}?search=test</a></li>
            </ul>
        </div>
        
        <div>
            <h4 class="text-md font-medium text-gray-800 mb-2">Aide sur la sélection utilisateur</h4>
            <p class="text-sm text-gray-600 mb-2">Si le sélecteur d'utilisateur ne fonctionne pas correctement, vous pouvez essayer les actions suivantes:</p>
            <div class="flex space-x-2">
                <button type="button" id="debug_select_first" class="px-3 py-1 bg-gray-200 text-gray-700 rounded-md text-sm">
                    Sélectionner premier utilisateur
                </button>
                <button type="button" id="test_search_url" class="px-3 py-1 bg-gray-200 text-gray-700 rounded-md text-sm">
                    Tester URL recherche
                </button>
                <button type="button" id="check_jquery" class="px-3 py-1 bg-gray-200 text-gray-700 rounded-md text-sm">
                    Vérifier jQuery
                </button>
            </div>

...
<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Detailed information about the time entry</p>
        </div>
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <span class="px-3 py-1 rounded-full text-sm font-semibold
                    ...
                    @elseif($timeEntry->status === 'late') bg-yellow-100 text-yellow-800
        ...
        <div class="px-6 py-4">
            <dl class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <dd class="mt-1 text-sm text-gray-900">{{ $timeEntry->date->format('Y-m-d') }}</dd>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">
                            {{ $timeEntry->check_in ? $timeEntry->check_in->format('H:i') : 'Not specified' }}
                        </dd>
                    </div>
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">
                            {{ $timeEntry->check_out ? $timeEntry->check_out->format('H:i') : 'Not specified' }}
                        </dd>
                    </div>
                </div>
